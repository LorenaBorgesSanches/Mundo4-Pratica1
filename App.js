  ...
  useEffect(() => {
    getData().then((newData) => {
      if (!newData || JSON.stringify(newData) === '{}' || JSON.stringify(newData) === '[]') {
        newData = [
          { id: 1, nome: "Pessoa de Exemplo 1", endereco: "endereco", contato: "contato", categoria: "categoria" },
          { id: 2, nome: "Pessoa de Exemplo 2", endereco: "aaaaaaaa", contato: "bbbbbbb", categoria: "bbbbbbbbb" }];
      }
      setData(newData);
    });
  }, [])
